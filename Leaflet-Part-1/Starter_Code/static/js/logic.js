...
function createFeatures(earthquakeData, platesData){
    ...
    // popup describing the place and time of earthquakes
    // Define a function that will run for each feature in the arrays
    ...
    // Send earthquakes layer to the createMap function and adding the features 
...
function createMap(earthquakes) {
   // Define outdoors and graymap layershttps://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png
  ...
  // Defining the baseMaps object to hold our base layers
  let baseMaps = {
